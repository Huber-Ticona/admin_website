...
def imagenes():
    ...
    imagenes = os.listdir('../new_website/Productos')
...
def imagen_producto(nombre = None):
	try:
		return send_file('../new_website/Productos/'+ nombre , download_name = nombre)
